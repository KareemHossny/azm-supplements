...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full space-y-6">
      ...
      {confirmed && <div className="rounded-xl bg-emerald-500/10 p-3 text-sm text-emerald-400">تم إنشاء الحساب بنجاح! يرجى تسجيل الدخول</div>}
  ...
  return (
    <div className="min-h-screen bg-azm-black text-white">
      ...
      <div className="mx-auto flex min-h-[80vh] max-w-md items-center justify-center px-4">
        <Suspense fallback={<div className="text-white/60">جاري التحميل...</div>}>
          <LoginForm />
        </Suspense>
      </div>
      <SiteFooter />
